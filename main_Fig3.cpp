...
extern const double Lmax=pow(0.1,0.5); //size of the grid
...
//	std::vector<double> Utot_list{0.5,2.5 };
//	std::vector<double> Utot_list{0.1 };
	...
	f0.open("Spatial_distribution_particle_Fig3_dx10m8_small_area_high_U.txt");
	f1.open("pcf_particle_Fig3_dx10m8_small_area_high_U.txt");
