...
\usepackage{babel}
\begin{document}
\title{Analytical solution for the pair correlation function}
\maketitle

\section*{Derivation of G(r,t)}
...
\section*{Analytical solution with advection}
...
\subsection*{Analytical solution without advection}
